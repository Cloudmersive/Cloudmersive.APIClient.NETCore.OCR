...
> PhotoToWordsWithLocationResult ImageOcrPhotoWordsWithLocation (System.IO.Stream imageFile, string language = null)
...
namespace Example
{
    public class ImageOcrPhotoWordsWithLocationExample
    {
        public void main()
        {
            ...
            {
                // Convert a photo of a document or receipt into words with location
                PhotoToWordsWithLocationResult result = apiInstance.ImageOcrPhotoWordsWithLocation(imageFile, language);
                Debug.WriteLine(result);
            }
            catch (Exception e)
            {
