...
> FormRecognitionResult ImageOcrPhotoRecognizeForm (System.IO.Stream imageFile, string formTemplateDefinition = null, string recognitionMode = null, string language = null)
...
namespace Example
{
    public class ImageOcrPhotoRecognizeFormExample
    {
        public void main()
        {
            ...
            {
                // Recognize a photo of a form, extract key fields and business information
                FormRecognitionResult result = apiInstance.ImageOcrPhotoRecognizeForm(imageFile, formTemplateDefinition, recognitionMode, language);
                Debug.WriteLine(result);
            }
            catch (Exception e)
            {
...
> ReceiptRecognitionResult ImageOcrPhotoRecognizeReceipt (System.IO.Stream imageFile, string formTemplateDefinition = null, string recognitionMode = null, string language = null)
...
namespace Example
{
    public class ImageOcrPhotoRecognizeReceiptExample
    {
        public void main()
        {
            ...
            {
                // Recognize a photo of a receipt, extract key business information
                ReceiptRecognitionResult result = apiInstance.ImageOcrPhotoRecognizeReceipt(imageFile, formTemplateDefinition, recognitionMode, language);
                Debug.WriteLine(result);
            }
            catch (Exception e)
            {
