...
> PhotoToWordsWithLocationResult ImageOcrPhotoWordsWithLocation (System.IO.Stream imageFile, string language = null, string preprocessing = null)
...
namespace Example
{
    public class ImageOcrPhotoWordsWithLocationExample
    {
        public void main()
        {
            ...
            {
                // Convert a photo of a document or receipt into words with location
                PhotoToWordsWithLocationResult result = apiInstance.ImageOcrPhotoWordsWithLocation(imageFile, language, preprocessing);
                Debug.WriteLine(result);
            }
            catch (Exception e)
            {
