# Cloudmersive.APIClient.NETCore.OCR.Api.PdfOcrApi
...
namespace Example
{
    public class PdfOcrPdfToLinesWithLocationExample
    {
        public void main()
        {
            ...
            var imageFile = new System.IO.Stream(); // System.IO.Stream | PDF file to perform OCR on.
            ...
            {
                Debug.Print("Exception when calling PdfOcrApi.PdfOcrPdfToLinesWithLocation: " + e.Message );
            }
        }
    }
}
...
------------- | ------------- | ------------- | -------------
 **imageFile** | **System.IO.Stream**| PDF file to perform OCR on. | 
...
namespace Example
{
    public class PdfOcrPdfToWordsWithLocationExample
    {
        public void main()
        {
            // Configure API key authorization: Apikey
            ...
            {
                Debug.Print("Exception when calling PdfOcrApi.PdfOcrPdfToWordsWithLocation: " + e.Message );
            }
        }
    }
}
...
<a name="pdfocrpost"></a>
# **PdfOcrPost**
> PdfToTextResponse PdfOcrPost (System.IO.Stream imageFile, string recognitionMode = null, string language = null, string preprocessing = null)
